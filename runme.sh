...
sysbench --mysql-user=root --mysql-password=jack1goza --mysql-db="sbtest" --db-driver=mysql --table_size=200000 /usr/share/sysbench/oltp_read_write.lua prepare
...
sysbench --mysql-user=root --mysql-password=jack1goza --mysql-db="sbtest" --db-driver=mysql --table_size=200000 /usr/share/sysbench/oltp_read_write.lua cleanup
